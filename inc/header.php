...
if ($lang == "en") {
  require_once("massage_en.php");
}else{
  require_once("massage_ar.php");
}
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="handel/Logout.php"><?php echo $msg['logout']?></a>
              </li>
              <?php 
              else :
              ?>
              <li class="nav-item">
                <a class="nav-link" href="handel/Logout.php"><?php echo $msg['login']?></a>
              </li>
              <?php endif ; ?>
            </ul>
          </div>
